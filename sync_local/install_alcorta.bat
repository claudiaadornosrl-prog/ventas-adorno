@echo off
chcp 65001 > NUL
title Instalacion sync_ventas_local - ALCORTA
:: ════════════════════════════════════════════════════════════
::  Setup automatico de sync_ventas_local en el SERVER de Alcorta
...
:: ── 4) Crear .env ──────────────────────────────────────────
echo.
echo [4/5] Configurando archivo .env para ALCORTA...
if exist .env (
    echo.
...
(
    echo # ═══════════════════════════════════════════════════════════
    echo #  sync_ventas_local — ALCORTA
    echo #  Generado por install_alcorta.bat
    echo # ═══════════════════════════════════════════════════════════
    echo VENTAS_LOCAL=alcorta
...
echo.
echo ══════════════════════════════════════════════════════════
echo   ✓ INSTALACION COMPLETADA - ALCORTA
echo ══════════════════════════════════════════════════════════
echo.
